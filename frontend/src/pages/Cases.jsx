    ...
    <div className="cases-page">
      ...
      >
        <div>
          ...
          <p className="page-subtitle">Manage and track all court cases</p>
        </div>
        <button 
            ...
            return (
              ...
              >
                <div className="case-card-header">
                  <div>
                    <h3 className="case-title">{caseItem.case_number}</h3>
                    <span className={`case-badge type-${caseItem.case_type}`}>
                      {caseItem.case_type}
                    </span>
                  </div>
                ...
                <div className="case-card-body">
                  ...
                  <div className="case-metrics">
                    <div className="metric">
                      ...
                      <span className="metric-value">{caseItem.estimated_duration} min</span>
                    </div>
                    <div className="metric">
                      <span className="metric-label">Priority</span>
                      <span className="metric-value">{(caseItem.priority || 0).toFixed(2)}</span>
                    </div>
                  </div>
                  ...
                  {schedule && (
                    <div className="schedule-info-box">
                      <Eye size={14} />
                      <span>
                        Scheduled: {new Date(schedule.start_time).toLocaleDateString('en-IN')} at{' '}
                        {new Date(schedule.start_time).toLocaleTimeString('en-IN', { 
                          hour: '2-digit', 
                          minute: '2-digit' 
                        })}
                      </span>
          ...
          >
            ...
            >
              <div className="modal-header">
                <h2>{selectedCase ? 'Edit Case' : 'Add New Case'}</h2>
                <button 
                  className="close-btn"
                  onClick={() => setShowModal(false)}
                >
              ...
              <form onSubmit={handleSubmit} className="case-form">
                ...
                <div className="form-group">
                  ...
                  <small style={{color: 'var(--text-secondary)', fontSize: '0.85rem'}}>
                    💡 Tip: Include details about urgency, complexity, and expected witnesses for better AI analysis
                  </small>
                </div>

                <div className="form-group">
                  <label htmlFor="filed_in">Filed Date *</label>
                  <input
                    id="filed_in"
                    type="date"
                    required
                    ...
                    onChange={(e) => {
                      ...
                      setFormData({...formData, filed_in: e.target.value});
                    }}
                  />
                </div>
                ...
                <div className="info-box" style={{
                  ...
                  <p style={{margin: 0, fontSize: '0.9rem'}}>
                    🤖 <strong>AI-Powered Analysis:</strong> Based on your description, our AI will automatically calculate:
                  </p>
                  <ul style={{marginTop: '0.5rem', marginBottom: 0, paddingLeft: '1.5rem'}}>
                    <li>Urgency level (considering safety, time-sensitivity)</li>
                ...
                <div className="form-actions">
                  ...
                  <button type="submit" className="btn-primary">
                    {selectedCase ? 'Update Case' : 'Create Case with AI Analysis'}
                  </button>
                </div>
              </form>
            </motion.div>
