    ...
    <div className="judges-page">
      ...
      >
        <div>
          ...
          <p className="page-subtitle">Manage judges and view their schedules</p>
        </div>
        <button 
              ...
              >
                ...
                <div className="judge-stats">
                  <div className="stat">
                    <Calendar size={18} />
                    <div>
                      <span className="stat-value">{judgeSchedules.length}</span>
                      <span className="stat-label">Scheduled Cases</span>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              <div className="modal-header">
                <h2>{selectedJudge ? 'Edit Judge' : 'Add New Judge'}</h2>
                <button 
                  className="close-btn"
                  onClick={() => setShowModal(false)}
                >
              ...
              <form onSubmit={handleSubmit} className="judge-form">
                ...
                <div className="form-actions">
                  ...
                  <button type="submit" className="btn-primary">
                    {selectedJudge ? 'Update Judge' : 'Add Judge'}
                  </button>
                </div>
              </form>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="schedule-content">
                {getJudgeSchedules(selectedJudge.id).length === 0 ? (
                  ...
                  <div className="schedule-list">
                    {getJudgeSchedules(selectedJudge.id).map((schedule, idx) => {
                      const caseItem = getCaseById(schedule.case);
                      return (
                        <motion.div
                          key={schedule.id}
                        ...
                        >
                          <div className="schedule-header">
                            <FileText size={20} />
                            <div>
                              <h4>{caseItem?.case_number || `Case #${schedule.case}`}</h4>
                              {caseItem && (
                          ...
                          <div className="schedule-details">
                            <div className="detail">
                              <Clock size={16} />
                              <span>
                                {new Date(schedule.start_time).toLocaleString('en-IN', {
                                  dateStyle: 'medium',
                                  timeStyle: 'short'
                                })}
                              </span>
                            ...
                            <div className="detail">
                              <MapPin size={16} />
                              <span>{schedule.room || 'Courtroom 1'}</span>
                            </div>
                          </div>
                        </motion.div>
                      );
